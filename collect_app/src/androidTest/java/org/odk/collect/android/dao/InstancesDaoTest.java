...
public class InstancesDaoTest {
    ...
    public void getInstancesCursorForFilePathTest() {
        Cursor cursor = instancesDao.getInstancesCursorForFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Hypertension Screening_2017-02-20_14-03-53/Hypertension Screening_2017-02-20_14-03-53.xml");
        List<Instance> instances = instancesDao.getInstancesFromCursor(cursor);
        assertEquals(1, instances.size());
    ...
    public void updateInstanceTest() {
        Cursor cursor = instancesDao.getInstancesCursorForFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml");
        List<Instance> instances = instancesDao.getInstancesFromCursor(cursor);
        assertEquals(1, instances.size());
        ...
        Instance instance = new Instance.Builder()
                ...
                .instanceFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml")
                .jrFormId("N_Biggest")
        ...
        String[] whereArgs = {CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml"};

        assertEquals(instancesDao.updateInstance(instancesDao.getValuesFromInstanceObject(instance), where, whereArgs), 1);

        cursor = instancesDao.getInstancesCursorForFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Biggest N of Set_2017-02-20_14-24-46/Biggest N of Set_2017-02-20_14-24-46.xml");
    ...
    private void fillDatabase() {
        Instance instance1 = new Instance.Builder()
                ...
                .instanceFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Hypertension Screening_2017-02-20_14-03-53/Hypertension Screening_2017-02-20_14-03-53.xml")
        ...
        Instance instance2 = new Instance.Builder()
                ...
                .instanceFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Cascading Select Form_2017-02-20_14-06-44/Cascading Select Form_2017-02-20_14-06-44.xml")
        ...
        Instance instance3 = new Instance.Builder()
                .displayName("Biggest N of Set")
                .instanceFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Biggest N of Set_2017-02-20_14-06-51/Biggest N of Set_2017-02-20_14-06-51.xml")
                .jrFormId("N_Biggest")
                .status(InstanceProviderAPI.STATUS_SUBMITTED)
        ...
        Instance instance4 = new Instance.Builder()
                .displayName("Widgets")
                .instanceFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/Widgets_2017-02-20_14-06-58/Widgets_2017-02-20_14-06-58.xml")
                .jrFormId("widgets")
                .status(InstanceProviderAPI.STATUS_SUBMITTED)
        ...
        Instance instance5 = new Instance.Builder()
                .displayName("sample")
                .instanceFilePath(CollectInitialiser.INSTANCE.getINSTANCES_PATH() + "/sample_2017-02-20_14-07-03/sample_2017-02-20_14-07-03.xml")
                .jrFormId("sample")
                .status(InstanceProviderAPI.STATUS_INCOMPLETE)
