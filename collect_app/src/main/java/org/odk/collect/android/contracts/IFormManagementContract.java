...
public interface IFormManagementContract {
    ...
    /**
     *
     * @param formsString - JSON Array String containing Form ID and Form Name
     ...
     * @return HashMap<String, String> with key = FormID, value = FormName
     */
     ...
     */
    int fetchSpecificFormID(String formIdentifier);
